...
Console.WriteLine("Давайте найдем расстояние между точками А и В в пространстве 2D");
...
double result = Math.Sqrt(Math.Pow(BnumX - AnumX,2) + Math.Pow(BnumY - AnumY,2));
Console.WriteLine($"Расстояние между точками А и В в пространстве 2D равно {result}");
